...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { course_offering_id: @register.course_offering_id, grade: @register.grade, user_id: @register.user_id } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { course_offering_id: @register.course_offering_id, grade: @register.grade, user_id: @register.user_id } }
